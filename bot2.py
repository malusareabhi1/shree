...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Dashboard", "Get Stock Data", "Test Strategy", "Trade Log", "Account Info", "Strategy Detail", "Project Detail"],
        icons=["bar-chart", "search", "cpu", "clipboard-data", "wallet2", "info-circle", "file-earmark"],
        menu_icon="cast",
        default_index=0,
    )
